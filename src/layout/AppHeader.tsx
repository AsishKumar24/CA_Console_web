  ...
  return (
    <header className="sticky top-0 flex w-full 
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200/60 dark:border-gray-800/60 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          {/* Hamburger/Toggle Button with modern design */}
          <button
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-gray-600 dark:text-gray-400 rounded-lg z-99999 hover:bg-gray-100 dark:hover:bg-gray-800 lg:hidden transition-colors duration-200"
          >
            <svg
              width="24"
              height="24"
        ...
        <div
          className={`${
            ...
            border-t border-gray-100 dark:border-gray-800 lg:border-t-0`}
        >
          <div className="flex items-center gap-3">
            {/* Greeting Text */}
            <div className="hidden xl:block mr-2">
              <p className="text-xs text-gray-500 dark:text-gray-400">Welcome back,</p>
              <p className="text-sm font-semibold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
                {user?.firstName || "User"}
              </p>
            </div>

            {/* Divider */}
            <div className="hidden xl:block w-px h-8 bg-gradient-to-b from-transparent via-gray-300 dark:via-gray-700 to-transparent" />
