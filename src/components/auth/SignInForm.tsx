 ...
 * SignInForm
 *
 * This form authenticates the user using email + password.
 * Backend sets an HTTP-only cookie (7 days validity),
 * so no token handling is required on frontend.
 *
 * Future:
 * - "Keep me logged in" can be wired to backend to extend cookie duration.
 */
export default function SignInForm() {
  ...
  // Currently unused but kept for future backend enhancement
       ...
       BASE_URL+ "/auth/login",
        {
          email,
          password,
          // keepLoggedIn: isChecked // ← future use
        },
        {
        ...
        <div className="w-full">
          ...
          <div className="mb-8 sm:mb-10">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400">
              Sign in to access your CA Console dashboard
            </p>
          </div>
